...
<html lang="pt">
    <head>
        ...
        <link href="<?php echo base_url(); ?>bootstrap/css/style.css" rel="stylesheet" media="screen,projection">
        ...
        <link href="<?php echo base_url(); ?>bootstrap/m/css/materialize.css" rel="stylesheet" media="screen,projection">
        ...
        <nav  class="grey darken-4">
            <ul class="navbar-nav grey darken-4 ">
                <li class="nav-item active grey darken-4">
                    <a class="brand-logo-sm center  btn btn-group-toggle btn-dark waves-effect waves-green  darken-4 btn-hover btn btn-dark grey darken-4 btn-hover waves-green" href="<?php echo base_url(); ?>start/edicao/">Bem vindo: &nbsp;&nbsp;&nbsp; <?php echo strtoupper($this->session->nome); ?> <span class="sr-only">(current)</span></a>
                </li> 
            </ul>
        </nav>
    </header>
    <body class="body ">
        <div class="card-body ">
            <a class=" btn btn-group-toggle btn-dark waves-effect waves-green light-blue darken-4 btn-hover  " href="<?php echo base_url(); ?>hospital/inserir_paciente/">   Novo Paciente<span class="sr-only">(current)</span></a>
            <center >
                <br>
                <?php
                $id_teste = -1;
